...
class TechwordsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create techword" do
    assert_difference('Techword.count') do
      post techwords_url, params: { techword: { description: @techword.description, name: @techword.name } }
    end
  ...
  test "should update techword" do
    patch techword_url(@techword), params: { techword: { description: @techword.description, name: @techword.name } }
