class TechwordsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @techword.save
        format.html { redirect_to @techword, notice: 'Techword was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @techword.update(techword_params)
        format.html { redirect_to @techword, notice: 'Techword was successfully updated.' }
  ...
  def destroy
    @techword.destroy
    respond_to do |format|
      format.html { redirect_to techwords_url, notice: 'Techword was successfully destroyed.' }
  ...
  private
    ...
    def techword_params
      params.require(:techword).permit(:name, :description)
    end
end
